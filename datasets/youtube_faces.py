...
def read_train_split_to_str(image_list, bbox_files):
    ...
    # """
    image_list = []
    image_path = '/home/maxwell/Downloads/train/.....'
...
def read_train_split_to_image(image_list, bbox_files):
    ...
    image_list, bbox_files = read_train_split_to_str(image_path, bbox_dir)
...
def read_test_split_to_str(image_list,bbox_files):
    ...
    image_list = []
    image_path = '/home/maxwell/Downloads/test/.....'
    for home, dirs, files in os.walk(image_path):
        for filename in files:
            image_list.append(os.path.join(home,filename))
    print ("successfully get image list")  
    ...
    bbox_files = []
    bbox_dir = '/home/maxwell/Downloads/test/Youtube....'
    for f in sorted(os.listdir(bbox_dir)):
        domain = os.path.abspath(bbox_dir)
        f = os.path.join(domain,f)
        bbox_files += [f]
...
def read_test_split_to_image(image_list, bbox_files):
    ...
    image_list, bbox_files = read_test_split_to_str(image_list,bbox_files)
